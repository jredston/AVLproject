 ...
 *
 * assertTreeEquals(int[], Integer[], int[], int[]) - this method takes, the
 * positions, values, heights, and balances of all - the nodes in the AVL tree
 * and verifies the correctness of avlTree.
 *
 * - The positions are 1 index and level order (exactly like a heap) - For more
 * explanation, look at the comments in the instance variable - declarations
 * below
 *
...
public class SSTests {
    ...
    public void t38RemoveTwoChildrenRebalanceDoubleRightLeftRotation() {
         ...
         * BEFORE REBALANCING SINGLE ROTATION AFTER REBALANCING
         * 
         * 7 7 7 / \ / \ / \ 4 9 4 9 4 10 / \ / \ / / \ 2 11 2 10 2 9 11 / \ 10
         * 11
         */
        assertTreeEquals();
    }
    ...
    public void t40RemoveTwoChildrenRebalanceDoubleLeftRightRotation() {
         ...
         * BEFORE REBALANCING SINGLE ROTATION AFTER REBALANCING
         * 
         * 10 10 6 / \ / \ / \ 4 11 6 11 4 10 / \ / / \ \ 2 6 4 2 5 11 / / \ 5 2
         * 5
         */
        assertTreeEquals();
    }
