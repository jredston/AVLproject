...
/**
 * The interface for an AVL Tree. DO NOT EDIT THIS FILE!
 *
 * @author CS 1332 TAs
 * @version 1.0
 */
public interface AVLInterface<T extends Comparable<? super T>> {
    ...
    /**
     * Removes the data from the tree. There are 3 cases to consider: 1: the
     * data is a leaf. In this case, simply remove it. 2: the data has one
     * child. In this case, simply replace the node with the child node. 3: the
     * data has 2 children. There are generally two approaches: replacing the
     * data with either the largest element in the left subtree (commonly called
     * the predecessor), or replacing it with the smallest element in the right
     * subtree (commonly called the successor). For this assignment, use the
     * successor.
     *
     * @throws java.lang.IllegalArgumentException
     *             if the data is null
